...
import 'package:flutterstationaryshop/screens/welcomescreen.dart';
...
class _MyAppState extends State<MyApp> {
 ...
 /* void getCategory()  async {
    ...
    var catergory = await stationary.getCategoryList();

    print('in Main:- $catergory');
